...
public class FormController {
    ...
    private boolean groupIsFieldList(FormIndex index) {
        ...
        return (FormController.FIELD_LIST.equalsIgnoreCase(gd.getAppearanceAttr()));
    }
                ...
                group_skip: do {
                    ...
                    switch (event) {
                        ...
                        case FormEntryController.EVENT_REPEAT:
                            ...
                            break;
                        case FormEntryController.EVENT_REPEAT_JUNCTURE:
                        	System.err.printf(t, "repeat juncture: "
        ...
        if (element instanceof GroupDef) {
            ...
            if ( gd.getChildren().size() == 1 && getEvent(idxChild) == FormEntryController.EVENT_GROUP ) {
                ...
                if (nestedElement instanceof GroupDef) {
                    ...
                    if ( FormController.FIELD_LIST.equalsIgnoreCase(nestedGd.getAppearanceAttr()) ) {
                    	gd = nestedGd;
		...
		if (constraintText != null) {
			...
			if(xPathRequiredMsg != null) {
				try{
					...
					System.err.printf(t,"Error evaluating a valid-looking required xpath ", e);
					return constraintText;
				}
			} else {
				return constraintText;
